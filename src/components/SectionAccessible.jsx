...
export default function SectionAccessible() {
  return (
    <section className="section-accessibilities">
          ...
          <div className="col col-lg-12">
            <div className="text-center btn-container">
              <button
                ...
                className="accessibility-btn album btn section-button buttonDonate"
              >
          ...
          <div className="donate-modal-body">
            <div className="donate-box">
              <div className="donate-card">
                ...
                <img className="qr-code-image" src="/img/qrcode.jpg" />
                <p>
